...
class LexerTestVersion2 {
    ...
    fun testIfAndElseStatement() {
        ...
        expectedTokens.add(Token(PrototypeType.OPEN_KEY, null, 5, 6, 1))
        ...
        expectedTokens.add(Token(PrototypeType.CLOSE_KEY, null, 0, 1, 3))
        expectedTokens.add(Token(PrototypeType.ELSE, null, 1, 5, 3))
        expectedTokens.add(Token(PrototypeType.OPEN_KEY, null, 5, 6, 3))
        ...
        expectedTokens.add(Token(PrototypeType.CLOSE_KEY, null, 0, 1, 5))
        Assertions.assertEquals(expectedTokens, actualTokens)
    }
    ...
    fun testConstLine() {
        ...
        expectedTokens.add(Token(PrototypeType.SPACE, null, 15, 16, 1))
        expectedTokens.add(Token(PrototypeType.ASSIGNATION, null, 16, 17, 1))
    ...
    fun testBooleanLineTrue() {
        ...
        expectedTokens.add(Token(PrototypeType.ASSIGNATION, null, 15, 16, 1))
