...
class FormatterTest {
            ...
            listOf(
                ...
                AssignmentNode(
                    ...
                    Operation(
                        ...
                        Operator.SUM,
                        Variable("1", PrototypeType.NUMBER, 3),
                        3
                    ),
                    3
                ),
                PrintNode(
                    Operation(
                        Variable("a", PrototypeType.IDENTIFIER, 4),
                        Operator.SUM,
                        Variable("b", PrototypeType.IDENTIFIER, 4),
                        4
                    ),
                    4
                )
    ...
    fun testFormatterWithAssigmentNode() {
        ...
        val node1 = AssignmentNode(
            "b",
            Operation(
                Variable("22", PrototypeType.NUMBER, 1),
                Operator.SUM,
                Variable("20", PrototypeType.NUMBER, 1),
                1
            ),
            1
        )
    ...
    fun testFormatterWithDeclarationNode() {
        ...
        val node1 = VariableDeclarationNode(
            ...
            Operation(
                ...
                Operator.SUM,
                Operation(
                    Variable("4", PrototypeType.NUMBER, 1),
                    Operator.MUL,
                    Variable("5", PrototypeType.NUMBER, 1),
                    1
                ),
                1
            ),
    ...
    fun testFormatterWithExpressionNode() {
        val node =
            Operation(Variable("22", PrototypeType.NUMBER, 1), Operator.SUM, Variable("20", PrototypeType.NUMBER, 1), 1)
